...
<head>
    ...
    <title>{{ $pageTitle ?? 'Login Siswa' }} - {{ config('app.name') }}</title>
    ...
    <style>
        * {
        ...
        .login-container {
            ...
            min-height: 100vh;
            width: 100vw;
            background: linear-gradient(135deg, #1e40af 0%, #3b82f6 25%, #06b6d4 50%, #0891b2 75%, #1e3a8a 100%);
        ...
        <div class="login-card-wrapper">
            ...
            <div class="login-section">
                <div class="login-header">
                    <h2 class="login-title">Panel Siswa<br>SMK MAHARDHIKA</h2>
                    <p class="login-subtitle">Masuk dengan NIS atau Email Anda</p>
                </div>
                ...
                <form action="{{ route('student.login') }}" method="POST">
                    ...
                    <div class="form-group">
                        <label for="identity" class="form-label">NIS atau Email</label>
                        <input id="identity"
                               class="form-input @error('identity') error @enderror"
                               type="text"
                               name="identity"
                               value="{{ old('identity') }}"
                    ...
                    <div class="signup-section">
                        <p>Butuh bantuan?</p>
                        <a href="#" class="signup-link">Hubungi Admin</a>
                    </div>
                </form>
            </div>
        </div>
